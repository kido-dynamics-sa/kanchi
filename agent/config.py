...
class Config:
    ...
    # Redis configuration used for lightweight operational key lookups
    redis_url: str | None = os.getenv("REDIS_URL")
    company_concurrency_redis_url: str | None = os.getenv("COMPANY_CONCURRENCY_REDIS_URL")
    company_concurrency_redis_db: int = int(os.getenv("COMPANY_CONCURRENCY_REDIS_DB", "2"))
    ...
    cors_allow_credentials: bool = _as_bool(
    ...
    token_secret_key: str = os.getenv(
        "TOKEN_SECRET_KEY", os.getenv("SESSION_SECRET_KEY", "change-me")
    )
